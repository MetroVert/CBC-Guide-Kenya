    ...
    >
      <div className="resource-section-inner">
        <div className="resource-section-header">
          ...
          <h2 id={`${id}-heading`} className="resource-section-title">
            {title}
          </h2>
        </div>
          ...
          {items.map((item) => (
            <div key={item.title} className="resource-card">
              <div className="resource-card-top">
                ...
                {item.meta && (
                  <span className="resource-badge">{item.meta}</span>
                )}
              </div>
    ...
    <>
      ...
      <nav className="breadcrumb-bar" aria-label="Breadcrumb">
        <div className="breadcrumb-inner">
          <ol className="breadcrumb-list">
            ...
            <li>
              <Link href="/grades/grade-8" className="breadcrumb-link">
                Grade 8
              </Link>
            </li>
            <li aria-hidden="true" className="breadcrumb-sep">
      ...
      <section className="subject-hero" aria-labelledby="subject-hero-heading">
        <div className="subject-hero-inner">
          ...
          <div className="subject-hero-tagline" style={{ color: c.icon }}>
            {content.tagline}
          </div>
          <h1 id="subject-hero-heading" className="subject-hero-name">
            {content.name}
          </h1>
          ...
          <div className="subject-hero-stats">
            <div className="subject-hero-stat">
              <span
                className="subject-hero-stat-number"
                style={{ color: c.icon }}
              >
      ...
      <section className="topics-section" aria-labelledby="topics-heading">
        <div className="topics-inner">
          ...
          <p className="section-sub section-sub--left">
            A complete breakdown of what you'll study in {content.name}.
          </p>
      ...
      <ResourceSection
        ...
        iconKey="notes"
        items={content.notes}
        colorKey={content.colorKey}
      />
      <ResourceSection
        id="practice-questions"
        title="Practice Questions"
        iconKey="practice"
        items={content.practiceSets}
        colorKey={content.colorKey}
      />
      <ResourceSection
        id="quizzes"
